        ...
        dataRepository.goodsDetail(map, new RemotDataSource.getCallback() {
            ...
            public void onSuccess(Object data) {
                ...
                if (goodsDetailModel.getCode() == 1) {
                    ...
                    tvSurplus1.setText("仅剩:" + goodsDetailModel.getData().getDetail().getGoods_sku().getStock_num() + "件");
                    tvSales.setText("销量:" + goodsDetailModel.getData().getDetail().getGoods_sku().getGoods_sales() + "件");
                    tvSurplus.setText("剩余:" + goodsDetailModel.getData().getDetail().getGoods_sku().getGoods_sales() + "件");
