...
public class GroupAfterSaleListActivity extends BaseActivity {
    ...
    private void initTabLayout() {
        ...
        fragments.add(new GroupAfterSaleListFragment("-1"));
        fragments.add(new GroupAfterSaleListFragment("0"));
