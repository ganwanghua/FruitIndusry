...
public class GroupInnerOrderAdapter extends BaseAdapter<GroupOrderListModel.DataBeanX.ListBean.DataBean.GoodsBean, GroupInnerOrderAdapter.VH> {


    public GroupInnerOrderAdapter(Context mContext) {
        super(mContext);
    }
