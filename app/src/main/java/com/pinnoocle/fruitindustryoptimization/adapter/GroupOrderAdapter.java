...
public class GroupOrderAdapter extends BaseAdapter<GroupOrderListModel.DataBeanX.ListBean.DataBean, GroupOrderAdapter.VH> {


    public GroupOrderAdapter(Context mContext) {
        super(mContext);
    }
...
//        }
        ...
        List<GroupOrderListModel.DataBeanX.ListBean.DataBean.GoodsBean> goods = mDatas.get(position).getGoods();
        GroupInnerOrderAdapter adapter = new GroupInnerOrderAdapter(mContext);
